...
- Copyable diagnostics may report archive enabled state, retention setting, and entry counts, but must never include archived text or raw transcript text.
...
- Clear archive and retention-delete operations are destructive and require confirmation.
